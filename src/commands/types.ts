...
export async function runTypes() {
  ...
  const aliasOutput = resolve(config.root, '.astropress/types.d.ts');
...
async function fetchBridgeTypes(baseUrl: string) {
  const url = `${baseUrl.replace(/\/$/, '')}/wp-json/astropress/v1/types`;
...
function renderTypes(schema: BridgeTypesResponse) {
  ...
  return `// Generated by AstroPress. Do not edit by hand.
